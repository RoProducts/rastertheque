package de.rooehler.rastersampleapplication.activities;
...
import de.rooehler.rastersampleapplication.dialog.FilePickerDialog;
import de.rooehler.rastersampleapplication.dialog.FilePickerDialog.FilePathPickCallback;
import de.rooehler.rastersampleapplication.rasterrenderer.RasterLayer;
import de.rooehler.rastersampleapplication.rasterrenderer.gdal.GDALFileRenderer;
import de.rooehler.rastersampleapplication.rasterrenderer.mbtiles.MBTilesRenderer;
import de.rooehler.rastersampleapplication.util.RendererType;
	...
	private void setMapStyle(final RendererType type, final String filePath) {
		...
		try{
			...
			case MBTILES:
				...
				MBTilesRenderer mbTilesRenderer = new MBTilesRenderer(getBaseContext(), AndroidGraphicFactory.INSTANCE, filePath);
				Layer mbTilesLayer = new RasterLayer(getBaseContext(), tileCache, mvp, false, AndroidGraphicFactory.INSTANCE, mbTilesRenderer);
			...
			case RASTER:
				...
				GDALFileRenderer gdalFileRenderer = new GDALFileRenderer(AndroidGraphicFactory.INSTANCE, GDALDecoder.getCurrentDataSet(), filePath);
				Layer rasterLayer = new RasterLayer(getBaseContext(),tileCache, mvp, false, AndroidGraphicFactory.INSTANCE, gdalFileRenderer);
